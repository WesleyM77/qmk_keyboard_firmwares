...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_65_with_macro(
    _______,   KC_MPLY,      QK_GESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,       KC_7,    KC_8,       KC_9,    KC_0,    KC_MINS,   KC_EQL,   KC_DEL,   KC_BSPC, KC_HOME,
    ...
    KC_MUTE,   KC_CALC,      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                KC_N,    KC_M,    KC_COMM,  KC_DOT,    KC_SLSH,  KC_RSFT,    KC_UP,   KC_PGDN,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [1] = { ENCODER_CCW_CW(BL_UP, BL_DOWN),  ENCODER_CCW_CW(KC_VOLD, KC_VOLU)  },
};
#endif